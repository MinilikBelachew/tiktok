...
const DepositPage: React.FC = () => {
  ...
  const handleContinue = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Deposit submit:', { amount, selectedMethod });
  };
          ...
          <div className="bg-gray-200 border border-gray-300 rounded-xl shadow-md p-4 sm:p-6 mx-[0.3cm] mb-[0.3cm]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-white border border-gray-300 rounded-xl p-4 sm:p-6 min-w-0">
                {/* Title instead of toggle */}
                <h1 className="text-center text-lg sm:text-xl font-bold text-dark-blue mb-6">Deposit</h1>
                ...
                <form onSubmit={handleContinue}>
                  ...
                  <button
                    ...
                    className={`block mx-auto w-3/4 sm:w-1/2 text-white font-semibold rounded-xl py-4 ${
                      !amount || !selectedMethod ? 'bg-blue-300 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'
                    }`}
                  >
                    Continue
                  </button>
