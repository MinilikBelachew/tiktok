...
const getSettledMarkets = async (req: Request, res: Response) => {
  try {
    const markets = await prisma.market.findMany({
...
const getOpenMarkets = async (req: Request, res: Response) => {
  try {
    const markets = await prisma.market.findMany({    
      where: { status: "OPEN" },
      orderBy: { startTime: "asc" },
...
const getUpcomingMarkets = async (req: Request, res: Response) => {
  try {
    const markets = await prisma.market.findMany({
...
const updateMarket = async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (participants && Array.isArray(participants)) updateData.participants = participants;
...
const activateMarket = async (req: Request, res: Response) => {
  const { id } = req.params;
...
const deactivateMarket = async (req: Request, res: Response) => {
  const { id } = req.params;
