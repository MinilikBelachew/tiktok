...
import { createMarket, deleteMarket, getMarketById, getMarkets, getOpenMarkets, getSettledMarkets, getUpcomingMarkets, updateMarket, activateMarket, deactivateMarket, } from "../controllers/admin/market.js";
...
const router = Router();
router.post("/create", uploadProfileImage, cloudinaryUpload, authenticate, adminOnly, createMarket);
// READ
